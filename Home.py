...
pages = [
    {
        ...
        "file": "pages/1_basic.py",
    },
    {
        "icon": "🔍",
        "title": "Search Enabled Chat",
        "description": "AI with internet search capabilities",
        "file": "pages/2_chatbot_agent.py",
    },
    {
        "icon": "📚",
        "title": "RAG",
        "description": "Retrieval-Augmented Generation with documents",
        "file": "pages/3_chat_with_your_data.py",
    },
    {
        "icon": "🔧",
        "title": "MCP Chatbot",
        "description": "Model Context Protocol integration",
        "file": "pages/4_mcp_agent.py",
    },
]
...
for page_info in pages:
    HomePageUI.render_feature_card(
        page_info["icon"], page_info["title"], page_info["description"]
    )
